<?php
class c_pkppk extends CI_Controller {
	...
	function index(){
		...
		if(isset($_SESSION['udhmasuk'])){
			$this->load->view('pkppk/index', $data);
		}
		else{
	...
	public function add() {
		...
		if(isset($_SESSION['udhmasuk'])){
			$this->load->view('pkppk/form',$data);
		}
		else{
			redirect('c_login/index');
		}
	...
	public function edit($id_unit) {
		...
		if(isset($_SESSION['udhmasuk'])){
			$this->load->view('pkppk/form_edit',$data);
		}
		else{
			redirect('c_login/index');
		}
	...
	function laporan(){
		...
		if(isset($_SESSION['udhmasuk'])){
			$this->load->view('pkppk/laporan', $data);
		}
		else{
			redirect('c_login/index');
		}
	...
	function hasil_laporan(){
        ...
        $data['title'] = "Laporan";
		if(isset($_SESSION['udhmasuk'])){
			$this->load->view('pkppk/hasil_laporan', $data);
		}
		else{
			redirect('c_login/index');
		}
    ...
    public function upload($id_unit) {
		...
		$data['sql'] = $this->m_unit->edit($id_unit);
		if(isset($_SESSION['udhmasuk'])){
			$this->load->view('pkppk/form_upload',$data);
		}
		else{
			redirect('c_login/index');
		}
