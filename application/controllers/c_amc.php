<?php
class c_amc extends CI_Controller {
	...
	public function edit($id_unit) {
		...
		if(isset($_SESSION['udhmasuk'])){
			$this->load->view('amc/form_edit',$data);
		}
		else{
			redirect('c_login/index');
		}
	...
	function laporan(){
		...
		if(isset($_SESSION['udhmasuk'])){
			$this->load->view('amc/laporan', $data);
		}
		else{
			redirect('c_login/index');
		}
	...
	function hasil_laporan(){
        ...
        $data['title'] = "Laporan";
		if(isset($_SESSION['udhmasuk'])){
			$this->load->view('amc/hasil_laporan', $data);
		}
		else{
			redirect('c_login/index');
		}
    ...
    public function upload($id_unit) {
		...
		$data['sql'] = $this->m_unit->edit($id_unit);
		if(isset($_SESSION['udhmasuk'])){
			$this->load->view('amc/form_upload',$data);
		}
		else{
			redirect('c_login/index');
		}
