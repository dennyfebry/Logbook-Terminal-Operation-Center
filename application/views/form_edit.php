                  ...
                  <div class="x_content">
                    ...
                    <form role="form" action="<?php echo base_url(); ?>index.php/c_unit/simpan" method="POST">
                      ...
                      <div class="form-group">
                        <label>Unit : </label>
                        <select name="unit">
                          <option value="AMC" <?php $obj->unit == 'AMC' ? print "selected": "" ?>>AMC</option>
                          <option value="PKPPK" <?php $obj->unit == 'PKPPK' ? print "selected": "" ?>>PKPPK</option>
                          <option value="AVSEC" <?php $obj->unit == 'AVSEC' ? print "selected": "" ?>>AVSEC</option>
                        </select>
                      </div>
                      <div class="form-group">
                        <label>Tanggal</label>
