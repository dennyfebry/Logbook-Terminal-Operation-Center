                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <!-- <li><a href="<?php echo base_url(); ?>index.php/c_unit/add"><button  class="btn btn-success" >Add New</button></a> -->
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                    ...
                    <table id="mytable" class="table table-striped table-bordered">
                      ...
                      <tbody>                       
                        <tr style="background-color: white;">
                          ...
                          <th width="170px"><a href="<?php echo base_url(); ?>index.php/c_unit/edit_unit/<?php echo $row->id_unit;?>" class="btn btn-info btn-xs" style="font-size: 12px;"></i> Edit</a>
                            <a href="<?php echo base_url(); ?>index.php/c_unit/upload/<?php echo $row->id_unit;?>" class="btn btn-info btn-xs" style="font-size: 12px;"></i> Upload</a>
                          <a href="<?php echo base_url(); ?>index.php/c_unit/hapus/<?php echo $row->id_unit;?>" onclick="return confirm('anda yakin ingin menghapus?')" class="btn btn-danger btn-xs" style="font-size: 12px;">Hapus</a>
                          </a>
                        </th>
                        </tr>
                      </tbody>
