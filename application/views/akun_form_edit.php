                  ...
                  <div class="x_content">
                    ...
                    <form role="form" action="<?php echo base_url(); ?>index.php/c_unit/simpan_akun" method="POST">
                      ...
                      <div class="form-group">
                        <label>Level : </label>
                        <select name="level">
                          <option value="AMC" <?php $obj->level == 'AMC' ? print "selected": "" ?> >AMC</option>
                          <option value="PKPPK" <?php $obj->level == 'PKPPK' ? print "selected": "" ?> >PKPPK</option>
                          <option value="AVSEC" <?php $obj->level == 'AVSEC' ? print "selected": "" ?> >AVSEC</option>
                        </select>
                      </div>
