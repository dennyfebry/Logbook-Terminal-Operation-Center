              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      ?>
                    <form role="form" action="<?php echo base_url(); ?>index.php/c_unit/simpan" method="POST">
                      ...
                      <div class="input-group clockpicker" data-placement="left" data-align="top" data-autoclose="true">
                        <input type="text" class="form-control" name="waktu_awal" required="">
                      ...
                      <div class="form-group">
                        ...
                        <button type="submit" value="submit" name="fileSubmit" class="btn btn-default">Simpan</button>
                    </form>
                  </div>
                </div>
              </div>
