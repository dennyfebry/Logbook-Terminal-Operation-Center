                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-table"></i> Unit <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url(); ?>index.php/c_amc/amc">AMC</a></li>
                    </ul>
                  </li>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      ?>
                    <form role="form" action="<?php echo base_url(); ?>index.php/c_amc/simpan" method="POST">
                      ...
                      <input type="hidden" class="form-control"  name="unit"  value="AMC">
