                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-table"></i> Unit <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url(); ?>index.php/c_avsec/index">AVSEC</a></li>
                    </ul>
                  </li>
                  <li><a href="<?php echo base_url(); ?>index.php/c_avsec/laporan"><i class="fa fa-print"></i> Laporan </a>
                  </li>
                </ul>
              </div>
            </div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li><a href="<?php echo base_url(); ?>index.php/c_avsec/add"><button  class="btn btn-success" >Add New</button></a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                    ...
                    <table  class="table table-striped table-bordered">
                      ...
                      <tbody>                       
                        <tr style="background-color: white;">
                          ...
                          <th width="170px"><a href="<?php echo base_url(); ?>index.php/c_avsec/edit/<?php echo $row->id_unit;?>" class="btn btn-info btn-xs" style="font-size: 12px;"></i> Edit</a>
                            <a href="<?php echo base_url(); ?>index.php/c_avsec/upload/<?php echo $row->id_unit;?>" class="btn btn-info btn-xs" style="font-size: 12px;"></i> Upload</a>
                          <a href="<?php echo base_url(); ?>index.php/c_avsec/hapus/<?php echo $row->id_unit;?>" onclick="return confirm('anda yakin ingin menghapus?')" class="btn btn-danger btn-xs" style="font-size: 12px;">Hapus</a>
                          </a>
                        </th>
                        </tr>
                      </tbody>
