              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      ?>
                    <form role="form" action="<?php echo base_url(); ?>index.php/c_avsec/simpan" method="POST">
                      ...
                      <input type="hidden" class="form-control"  name="unit"  value="AVSEC">
                      <div class="form-group">
                        <label>Tanggal</label>
                        <input type="date" class="form-control"  name="tanggal" min="2000-01-02" value="<?=date('Y-m-d');?>" required="">
                      </div>
                      <div class="form-group">
                        <label>Shift : </label>
                        <select name="shift">
