                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-table"></i> Unit <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="<?php echo base_url(); ?>index.php/c_unit/ausec">AUSEC</a></li>
                    </ul>
                  </li>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li><a href="<?php echo base_url(); ?>index.php/c_unit/add_akun"><button  class="btn btn-success" >Add New</button></a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                    ...
                    <table id="mytable" class="table table-striped table-bordered">
                      ...
                      <tbody>                       
                        <tr style="background-color: white;">
                          ...
                          <th width="110px"><a href="<?php echo base_url(); ?>index.php/c_unit/edit_akun/<?php echo $row->id_user;?>" class="btn btn-info btn-xs" style="font-size: 12px;"></i> Edit</a>
                          <a href="<?php echo base_url(); ?>index.php/c_unit/hapus_akun/<?php echo $row->id_user;?>" onclick="return confirm('anda yakin ingin menghapus?')" class="btn btn-danger btn-xs" style="font-size: 12px;">Hapus</a>
                          </a>
                        </th>
                        </tr>
                      </tbody>
